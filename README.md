...
So you must select **OAuth client ID**, select the application type **Other** and set as name: "Google Sheets API Quickstart" and create it. At the end, download credentials clicking in ![Download button](http://image.flaticon.com/icons/png/128/60/60721.png), place it in your project's root and rename it as `client_secret.json`.
